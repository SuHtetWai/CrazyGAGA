...
# region Images
# Top Banner images
LogoImageObject = Image.open("C:/Users/acer/Downloads/coastal lake house bedroom decor.jpg").resize((130, 130))
LogoImage = ImageTk.PhotoImage(LogoImageObject)

TopBannerImageObject = Image.open("C:/Users/acer/Downloads/coastal lake house bedroom decor.jpg").resize((800, 130))
TopBannerImage = ImageTk.PhotoImage(TopBannerImageObject)

# Menu images
displayDefaultImageObject = Image.open("C:/Users/acer/Downloads/coastal lake house bedroom decor.jpg").resize((350,360))
displayDefaultImage = ImageTk.PhotoImage(displayDefaultImageObject)

calamariImageObject = Image.open("C:/Users/acer/Pictures/furniture.jpg").resize((350,334))
calamariImage = ImageTk.PhotoImage(calamariImageObject)

burgerImageObject = Image.open("C:/Users/acer/Downloads/coastal lake house bedroom decor.jpg").resize((350,334))
burgerImage = ImageTk.PhotoImage(burgerImageObject)

salmonImageObject = Image.open("C:/Users/acer/Downloads/coastal lake house bedroom decor.jpg").resize((350,334))
salmonImage = ImageTk.PhotoImage(salmonImageObject)

shrimpImageObject = Image.open("C:/Users/acer/Downloads/coastal lake house bedroom decor.jpg").resize((350,334))
shrimpImage = ImageTk.PhotoImage(shrimpImageObject)

sushiImageObject = Image.open("C:/Users/acer/Downloads/coastal lake house bedroom decor.jpg").resize((350,334))
sushiImage = ImageTk.PhotoImage(sushiImageObject)

empanadasImageObject = Image.open("C:/Users/acer/Downloads/coastal lake house bedroom decor.jpg").resize((350,334))
